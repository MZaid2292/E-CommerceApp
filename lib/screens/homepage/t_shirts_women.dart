...
class TShirtsWomen extends StatefulWidget {
  const TShirtsWomen({super.key});

  @override
  _TShirtsWomenState createState() => _TShirtsWomenState();
}

class _TShirtsWomenState extends State<TShirtsWomen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Image.network(
                  "https://m.media-amazon.com/images/I/71k+ZFj2uEL._AC_SY741_.jpg",
                  height: 200,
                  fit: BoxFit.cover,
                ),
              ),
              ...
              Row(
                ...
                children: [
                  _buildThumbnail("https://m.media-amazon.com/images/I/71k+ZFj2uEL._AC_SY741_.jpg"),
                  _buildThumbnail("https://m.media-amazon.com/images/I/71oItoJVn8L._AC_SX569_.jpg"),
                  _buildThumbnail("https://m.media-amazon.com/images/I/7102mMl5zeL._AC_SY741_.jpg"),
                  _buildThumbnail("https://m.media-amazon.com/images/I/718NZFT5X-L._AC_SY741_.jpg"),
                ],
              ),
              const SizedBox(height: 16),
              const Text(
              ...
              if (_isDescriptionExpanded)
                Padding(
                  ...
                  child: Text(
                    "Soft & Lightweight Fabric – Feels smooth on the skin for all-day comfort.\n\n"
                        " Moisture-Wicking Technology – Keeps you fresh and sweat-free.\n\n"
                        " Stretchable & Durable – Ensures flexibility and long-lasting wear.\n\n"
                        "Classic Fit & Minimalist Design – Perfect for any occasion.\n\n\n\n"
                        " Available Sizes: S, M, L, XL, XXL\n"
                        "Material: Premium Polyester Blend\n"
                        " Ideal for: Sports, Gym, Casual Wear\n"
                    ,
  ...
  Widget _buildColorDropdown() {
    return _buildDropdown("Color", ["Pink", "Dark green", "Light Green", "White"]);
  }

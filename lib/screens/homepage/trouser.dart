...
class _TrouserState extends State<Trouser> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Image.network(
                  "https://m.media-amazon.com/images/I/61PM4WHBsML._AC_SY741_.jpg",
                  height: 200,
                  fit: BoxFit.cover,
                ),
              ),
              ...
              Row(
                ...
                children: [
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/61PM4WHBsML._AC_SY741_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/91Xr5Ya1F1L._AC_SX569_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/91WZpNKGHmL._AC_SX569_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/81BOOwWVEBL._AC_SX569_.jpg"),
                ],
              ),
              const SizedBox(height: 16),
              const Text(
              ...
              if (_isDescriptionExpanded)
                Padding(
                  ...
                  child: Text(
                    "Stay active and comfortable with these Men’s Athletic Track Trouser\n"
                    "Lightweight & breathable fabric for all-day comfort\n\n"
                    " Elastic waistband for a perfect fit\n\n"
                    "Zippered pockets to keep essentials secure\n\n"
                    "Straight-leg design for a modern and relaxed look\n\n"
                    "Ideal for gym, running, lounging, or casual outings\n\n"
                    "Available Sizes: S, M, L, XL, XXL\n\n"
                    "🏃‍♂️ Move in style – Get yours today!\n\n",
  ...
  Widget _buildColorDropdown() {
    return _buildDropdown("Color", ["Black", "White", "Grey", "Green", ]);
  }

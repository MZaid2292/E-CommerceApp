...
class _ShortsState extends State<Shorts> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Image.network(
                  "https://m.media-amazon.com/images/I/71I+w4YnysL._AC_SX679_.jpg",
                  height: 200,
                  fit: BoxFit.cover,
                ),
              ),
              ...
              Row(
                ...
                children: [
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71I+w4YnysL._AC_SX679_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71J-YZlOKvL._AC_SX679_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71lAuxb30dL._AC_SX679_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71bsMz7GdgL._AC_SX679_.jpg"),
                ],
              ),
              const SizedBox(height: 16),
              const Text(
                "Mens Workout Athletic Shorts",
              ...
              if (_isDescriptionExpanded)
                Padding(
                  ...
                  child: Text(
                    "Stay cool and comfortable with these Men’s Athletic Quick-Dry Shorts\n"
                       "Quick-dry & moisture-wicking fabric for ultimate comfort\n\n"
                    "Elastic waistband with adjustable drawstring for a custom fit\n\n"
                    "Deep side pockets & secure phone pocket for convenience\n\n"
                    "Perfect for gym, jogging, sports, and casual wear\n\n"
                    "Pack Includes: 2 Shorts (Black & Gray)\n\n"
                    "Available Sizes: S, M, L, XL, XXL\n\n"
                    "Material: Premium Polyester Blend\n\n"
                    "🏋️‍♂️ Stay active, stay stylish – Order now!\n\n",
  ...
  Widget _buildColorDropdown() {
    return _buildDropdown("Color", ["White", "Black", "Grey", "SKin Color" , "Green", ]);
  }

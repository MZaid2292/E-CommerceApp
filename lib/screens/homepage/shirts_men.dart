...
class ShirtsMen extends StatefulWidget {
  const ShirtsMen({super.key});

  @override
  _ShirtsMenState createState() => _ShirtsMenState();
}

class _ShirtsMenState extends State<ShirtsMen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Image.network(
                  "https://m.media-amazon.com/images/I/71z+GXNqeRL._AC_SX569_.jpg",
                  height: 200,
                  fit: BoxFit.cover,
                ),
              ),
              ...
              Row(
                ...
                children: [
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71z+GXNqeRL._AC_SX569_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/714eBfjunJL._AC_SX569_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/711wQlQsJZL._AC_SX569_.jpg"),
                  _buildThumbnail(
                      "https://m.media-amazon.com/images/I/71WFMlvTB9L._AC_SX569_.jpg"),
                ],
              ),
              const SizedBox(height: 16),
              const Text(
              ...
              if (_isDescriptionExpanded)
                Padding(
                  ...
                  child: Text(
                    "Men’s Stylish Casual Button-Up Shirt\n"
                    "Upgrade your wardrobe with this **premium long-sleeve casual shirt**, designed for the modern man who values both style and comfort. \n"
                  " **High-Quality Fabric** – Soft, breathable, and lightweight for all-day wear.  \n"
                  " **Elegant Contrast Design** – Features a stylish contrast lining on the collar and cuffs for a unique touch.  \n"
                  " **Versatile & Trendy** – Perfect for casual outings, office wear, parties, and date nights.  \n"
                  " **Slim-Fit Tailoring** – Enhances your physique while providing a comfortable fit.  \n"
                  "**Easy to Pair** – Matches perfectly with jeans, chinos, or dress pants.  \n"
                  " **A Must-Have for Every Fashion-Forward Man!** Order Now!  \n\n\n"
  ...
  Widget _buildColorDropdown() {
    return _buildDropdown("Color", ["Red", "Blue", "White", "Black", ]);
  }
